...
const allGeminiProviderPresets: GeminiProviderPreset[] = [
{
    ...
    settingsConfig: {
      env: {
        GOOGLE_GEMINI_BASE_URL: "https://api.juhe365.vip/v1",
        GEMINI_MODEL: "gemini-3.1-pro",
      },
    },
    baseURL: "https://api.juhe365.vip/v1",
    model: "gemini-3.1-pro",
    description: "Juhe365",
    category: "aggregator",
    endpointCandidates: ["https://api.juhe365.vip/v1"],
    icon: "generic",
    iconColor: "#3E50D8",
  },
{
...
export const geminiProviderPresets: GeminiProviderPreset[] =
  filterVisibleProviderPresets(allGeminiProviderPresets);
